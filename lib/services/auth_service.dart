...
class AuthService {
  final String baseUrl = "http://10.42.175.164:8000/api";

  Future<bool> login(String email, String password) async {
    final url = Uri.parse("http://10.42.175.164:8000/api/auth/login/");
  ...
  Future<void> wakeUpCameras() async {
    try {
      ...
      final url = Uri.parse('http://10.42.175.164:8000/camaras/start_cameras/');
